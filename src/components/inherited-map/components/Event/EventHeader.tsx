      ...
      <div style={{ width: "100%" }}>
        <div className="btns-container">
          ...
          <label className="viewSwitch" tabIndex={0}>
            <input type="checkbox" />
            <span className="viewSwitch-slider" />
        ...
        >
          ...
          <span style={{ color: Colors.$grey20, margin: "0 8px" }}>|</span> г
          Санкт-Петербург, ул Нижняя-Сырмятническая, 46к4
        </p>
        ...
        <div className="header-info-container">
          ...
          <div className="header-info">
            ...
            <p style={{ color: Colors.$greyDark, fontWeight: 500 }}>
              9 человек
            </p>
          </div>
          <div className="header-info">
