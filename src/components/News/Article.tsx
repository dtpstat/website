                ...
                <div className="article">
                    ...
                    <div style={{ marginBottom: '32px', paddingRight: '72px' }}>
                        <p className="bodySerif">
                            ...
                            района Кети Хараидзе. Но не стоит думать, что такая враждебность со
                            стороны общества мешает велосипедизации Москвы. Как раз наоборот!
                        </p>
                        ...
                        <p className="bodySerif">
                            Главной темой номера стал судебный иск, где заявители требовали убрать
                            защищённую велополосу вдоль общественного парка Проспект-парк
                            в Бруклине. Парадокс, но в роли истцов выступила группа под названием
                            «Соседи за качественные велодорожки» (Neighbors for Better Bike Lanes).
                        </p>
                        <p className="bodySerif" style={{ fontStyle: 'italic' }}>
                            По мотивам{' '}
                            <a href="#" style={{ borderBottom: `1px solid ${Colors.$greyDark}` }}>
                                Блумберга
                            </a>
