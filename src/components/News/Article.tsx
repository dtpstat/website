                    ...
                    <div className="article">
                        ...
                        <div className="article-body">
                            <p className="bodySerif">
                                ...
                                улице, как у нее появился противник в лице муниципального депутата
                                Тверского района Кети Хараидзе. Но не стоит думать, что такая
                                враждебность со стороны общества мешает велосипедизации Москвы.
                                Как раз наоборот!
                            </p>
                            ...
                            <p className="bodySerif">
                                ...
                                убрать защищённую велополосу вдоль общественного парка Проспект-парк
                                в Бруклине. Парадокс, но в роли истцов выступила группа под
                                названием «Соседи за качественные велодорожки» (Neighbors for Better
                                Bike Lanes).
                            </p>
