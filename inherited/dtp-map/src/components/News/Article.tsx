    ...
    <div>
      <div className='article-container'>
        <div className='container'>
          ...
          <h1
            className='h1'
            style={{ margin: '0 auto 12px', textAlign: 'center', maxWidth: '780px' }}
          >
          ...
          <div className='article'>
            ...
            <div className='article-body'>
              <p className='bodySerif'>
                Не прошло и недели с появления временной велодорожки на Лесной улице, как у нее
                появился противник в лице муниципального депутата Тверского района Кети Хараидзе. Но
                не стоит думать, что такая враждебность со стороны общества мешает велосипедизации
              ...
              <p className='bodySerif'>
                Главной темой номера стал судебный иск, где заявители требовали убрать защищённую
                велополосу вдоль общественного парка Проспект-парк в Бруклине. Парадокс, но в роли
                истцов выступила группа под названием «Соседи за качественные велодорожки»
